#!/bin/bash
#SBATCH --job-name=extract_ecg_episode
#SBATCH --partition=shared
#SBATCH --account=rsteven1
#SBATCH --time=00:40:00
#SBATCH --cpus-per-task=4
#SBATCH --mem=16G
#SBATCH --output=logs/extract_ecg_%j.out
#SBATCH --error=logs/extract_ecg_%j.err
set -euo pipefail
...
/scratch4/rsteven1/your_env_name/bin/python3.10 scripts/extract_ecg_features_episode.py
