#!/bin/bash
#SBATCH --job-name=final_allsegments
#SBATCH --partition=shared
#SBATCH --account=rsteven1
#SBATCH --time=03:00:00
#SBATCH --cpus-per-task=8
#SBATCH --mem=48G
#SBATCH --output=logs/allseg_%j.out
#SBATCH --error=logs/allseg_%j.err
set -euo pipefail
...
/scratch4/rsteven1/your_env_name/bin/python3.10 scripts/train_final_allsegments.py
