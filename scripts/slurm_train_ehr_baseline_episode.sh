#!/bin/bash
#SBATCH --job-name=ehr_baseline_episode
#SBATCH --partition=shared
#SBATCH --account=rsteven1
#SBATCH --time=00:30:00
#SBATCH --cpus-per-task=8
#SBATCH --mem=16G
#SBATCH --output=logs/ehr_base_ep_%j.out
#SBATCH --error=logs/ehr_base_ep_%j.err
set -euo pipefail
...
/scratch4/rsteven1/your_env_name/bin/python3.10 scripts/train_ehr_baseline_episode.py
