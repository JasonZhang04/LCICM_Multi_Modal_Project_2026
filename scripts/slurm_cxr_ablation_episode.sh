#!/bin/bash
#SBATCH --job-name=cxr_ablation_episode
#SBATCH --partition=shared
#SBATCH --account=rsteven1
#SBATCH --time=03:00:00
#SBATCH --cpus-per-task=8
#SBATCH --mem=48G
#SBATCH --output=logs/cxrabl_%j.out
#SBATCH --error=logs/cxrabl_%j.err
set -euo pipefail
...
/scratch4/rsteven1/your_env_name/bin/python3.10 scripts/train_cxr_ablation_episode.py
